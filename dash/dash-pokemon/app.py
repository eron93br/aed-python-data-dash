...
app.layout = html.Div(
    [
        ...
        html.Div(
            [
                html.Div(
                    [dcc.Dropdown(options=list_generations, value=list_generations[0], id='drop-gen')],
                    style={"display": "inline-block", 'margin-left' : '300px', "width": "15%"},
                ),
                html.Div(
                    [dcc.Dropdown(options=list_type, value=list_type[0], id='drop-type')],
                    style={"display": "inline-block",'margin-left' : '300px', "width": "15%"},
                ),
